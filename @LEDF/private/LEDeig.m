function [ Xq, Yq, time, para, best, ga_out, svds, Rqz, Rq ] = LEDeig( R,Rq, dim, options, para_range, display )
%%
...
switch lower(opt)
    case 'ga'
        ...
        if ~isequal(eta1_upper, eta1_lower) || ~isequal(eta2_upper,eta2_lower) || ...
            ...
            time = cputime;
            [x,fval,exitflag, ga_out] = ga(@(x) LEDeig_obj(x, R,Rq, dim, obj_type, obj_para),4,[],[],[],[],...
        ...
        para.alpha = x(3);
        para.beta = x(4);
        [~,Xq,Yq,svds, Rqz, Rq] = LEDeig_model(x, R, Rq, dim, obj_type, obj_para);
        ...
        if ~isequal(eta1_upper, eta1_lower) || ~isequal(eta2_upper,eta2_lower) || ...
            ...
            for eta1 = eta1_lower:0.5:eta2_upper           % linespace
                ...
                for eta2 =  eta2_lower:0.5:eta2_upper
                    ...
                    sigma = BB/BB(1);
                    for bta = beta_lower:0.3:beta_upper
                        %% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
