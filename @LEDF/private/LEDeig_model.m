function [score,X,Y,BB, Rqz, Rq] = LEDeig_model( x,R,Rq, k,obj_option, obj_para )
...
Rq1 = ACAS_R(Rq, obj_option, obj_para);
...
[score, Rqz, Rq] = KNN_obj(Rq1, X, Y, obj_option, obj_para);
